//
//  Student Info View ControllerViewController.swift
//  Student_App
//
//  Created by Kadali,Hema Durga Kiran on 4/4/23.
//

import UIKit

class Student_Info_View_ControllerViewController: UIViewController {
